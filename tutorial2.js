let tutorial2Scene = new Phaser.Scene('Tutorial2');

tutorial2Scene.init = function(data){
...
this.actText.moveTween=this.tweens.add({
                ...
                this.actText.moveTween=this.tweens.add({
                   ...
                   targets:this.actText,
                    ...
                    delay:0,
                    callbackScope:this,
                    onComplete:function(){this.actText.x=250
                                        this.actText.text = 'AWESOME!';
                   ...
                   targets:this.leftDrapes,
                    ...
                    delay:750,
                    callbackScope:this,
                    onComplete:function(){this.scene.start('Tutorial3', {music: this.music})}
                        });
...
this.actText.moveTween=this.tweens.add({
                   targets:this.actText,
                    ...
                    delay:0,
                    callbackScope:this,
                    onComplete:function(){this.actText.x=100
                                        this.actText.text = 'WHY SO STUPID?';
                this.actText.moveTween=this.tweens.add({
                   targets:this.actText,
                    y:301,
                    duration:750,
                    ...
                    callbackScope:this,
                    onComplete:function(){this.actText.x=100
                                        this.actText.text = 'YOU TRY HARDER!\n '+'';
                        this.leftDrapes.moveTween=this.tweens.add({
                   targets:this.leftDrapes,
                    x:-80,
                    duration:1500,
...
tutorial2Scene.create = function(){
    ...
    this.penguin.depth=1;
      ...
      this.actText.moveTween=this.tweens.add({
                   targets:this.actText,
                    ...
                    delay:1500,
                    callbackScope:this,
                    onComplete:function(){this.actText.text = 'PRESS RIGHT';}
                        });
...
tutorial2Scene.update = function(){
