let level21Scene = new Phaser.Scene('Level21');

level21Scene.init = function(){
  ...
  this.squishSanta=function(){
      ...
      this.leftDrapes.moveTween=this.tweens.add({
                   targets:this.leftDrapes,
                    ...
                    //delay:500,
                    callbackScope:this,
                    onComplete:function(){this.scene.start('Level22')}
                        });
...
this.act='Act 5-2';
  ...
  //create Santa 
  this.santa=this.physics.add.sprite(100,0, 'elf');
...
this.ground = this.add.tileSprite(0,600, 50*32, 1*28, 'snowTile') ; 
    ...
    this.platform2 = this.add.tileSprite(150,500, 32*1, 1*28, 'snowTile') ; 
    ...
    this.platform3 = this.add.tileSprite(450,300, 32*5, 1*28, 'snowTile') ; 
    ...
    this.platform4 = this.add.tileSprite(100,350, 3*32, 1*28, 'snowTile') ; 
    ...
    this.platform5 = this.add.tileSprite(200,400, 2*32, 1*28, 'snowTile') ; 
    ...
    this.platform6 = this.add.tileSprite(200,235, 4*32, 1*28, 'snowTile') ; 
    ...
    this.platform7 = this.add.tileSprite(100,500, 2*32, 1*28, 'snowTile') ; 
...
//make penguin wobble
  ...
  if(this.cursors.space.isDown &&this.penguin.body.touching.down==true|| this.cursors.up.isDown && this.penguin.body.touching.down==true){
    ...
    if (this.santa.y>64&&this.santa.body.touching.down==true){
        ...
        //check dot, move dot and shoot penguin
       if(this.dot!=null){
